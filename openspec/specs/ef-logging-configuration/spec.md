...
Configure Entity Framework Core logging behavior across development API projects, suppressing verbose SQL and query logs by default while allowing developers to opt in for debugging.
